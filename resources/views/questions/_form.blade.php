...
<div class="form-group">
    ...
    <textarea name="body" id="body" row="10" class="form-control {{$errors->has('body') ? 'is-invalid' : ' ' }}">{{old('body',$question->body)}}</textarea>
    @if($errors->has('body'))
...
<div class="form-group">
    <button type="submit" class="btn btn-lg btn-outline-primary">{{$btnText}}</button>
</div>